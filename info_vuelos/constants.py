...
DATA_FIELDS = ['flightNumber', 'company', 'plane', 'dep_date', 'dep_time', 'dep_airport_name', 'dep_airport_code', 'dep_terminal',
...
CSV_DELIMITER = ';'
SCRAPING_FRECUENCY = 30 #in minutes
SCRAPING_PERIOD = 48 #in hours